...
type TablePlayListsProps={
    playlists:PlayList[]
}
export default function TablePlayLists({playlists}:TablePlayListsProps) {
  return (
   <>
              ...
              <table className="min-w-full divide-y divide-gray-300 ">
                ...
                <tbody className="divide-y divide-gray-200">
                  {playlists.map((playlist) => (
                    <tr key={playlist.id}>
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{playlist.name}</td>
                     
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{playlist.user_name}</td>
