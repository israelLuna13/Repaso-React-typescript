...
type TablePlayListSongProps={
    playListSongs:PlayListSong[]

}
export function TablePlayListSong({playListSongs}:TablePlayListSongProps){
              ...
              <table className="min-w-full divide-y divide-gray-300 ">
                ...
                <tbody className="divide-y divide-gray-200">
                  {playListSongs.map((songs) => (
                    <tr key={songs.id}>
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{songs.name}</td>
                     
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{songs.title}</td>
